...
public class Modifiers 
{
	...
	{
		System.out.println("Rolling for the stats.");
		for(Character rolls: stats)
		{
			System.out.println("Strength: "+rolls.getStrength()
		...
		for(Character intelligenceMod: stats) //Intelligence Modifier
		{
			if(intelligenceMod.getIntelligence() == 20)
			{
				...
				System.out.println("Intelligence with +5 modifier: "+ intelligenceMod.getIntelligence());
			}
			...
			System.out.println("Intelligence with +4 modifier: "+ intelligenceMod.getIntelligence());
			}
			...
			else if(intelligenceMod.getIntelligence() == 17 || intelligenceMod.getIntelligence() == 16)
			{
				...
				System.out.println("Intelligence with +3 modifier: "+ intelligenceMod.getIntelligence());
			}
			...
			else if(intelligenceMod.getIntelligence() == 15 || intelligenceMod.getIntelligence() == 14)
			{
				...
				System.out.println("Intelligence with +2 modifier: "+ intelligenceMod.getIntelligence());
			}
			...
			else if(intelligenceMod.getIntelligence() == 13 || intelligenceMod.getIntelligence() == 12)
			{
				...
				System.out.println("Intelligence with +1 modifier: "+ intelligenceMod.getIntelligence());
			}
			
			else if(intelligenceMod.getIntelligence() == 11 || intelligenceMod.getIntelligence() == 10)
			{
				System.out.println("Intelligence with 0 modifier: "+ intelligenceMod.getIntelligence());
			}
